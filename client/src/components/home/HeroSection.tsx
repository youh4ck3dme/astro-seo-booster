    ...
    <section className="relative py-16 md:py-24 overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/kontakt">
              <div>
                <Button 
                  size="lg" 
                  className="text-lg h-14 px-8 bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 shadow-lg shadow-primary/30"
        ...
        <div className="hidden lg:block">
          <Card className="relative overflow-hidden bg-gradient-to-br from-primary via-accent to-secondary border-0 min-h-[420px] flex items-center justify-center p-12 shadow-2xl">
            <Truck className="h-40 w-40 text-primary-foreground opacity-95 drop-shadow-lg" />
